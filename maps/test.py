def Initialize(entity, board):
    ...
    ent0.AddToDialogueList('foo', 'Change for a dying man?', endFunction=lambda player,npc:player.FinishPlotEvent('talktoblind'))
    ...
    ent5.AddToDialogueList('foo', 'A broken car, with an angry man living inside.')
